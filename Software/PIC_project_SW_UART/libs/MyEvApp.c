...
_delay(1000);
 ...
 putsUSART("'/> <ttc v='0.6'/> <rd v='12'/> <amp v='0'/>");
 putsUSART("<pw  v='0'/><pw  v='0'/><pw  v='0'/><pw  v='0'/><pw  v='0'/><pw  v='0'/><pw  v='0'/><pw  v='0'/>");
 putsUSART("<pw  v='0'/><pw  v='0'/><pw  v='0'/>");
 putsUSART("<vol v='26.4'/><camp v='21.5'/> <temp v='0'/>");
 putsUSART("<max v='3.38'/><min v='3.34'/><avg v='3.36'/><mode v='3'/><mode2 v='3'/>");
 //putsUSART("<bt id='1' v='3.0' c='3'/> <bt id='2' v='1.1' c='0'/><bt id='3' v='1.8' c='1'/><bt id='4' v='2.6' c='2'/> <bt id='5' v='1.0' c='0'/> <bt id='6' v='1.6' c='1'/><bt id='7' v='2.2' c='2'/><bt id='8' v='1.9' c='1'/><bt id='9' v='3.3' c='3'/><bt id='10' v='2.0' c='2'/><bt id='11' v='3.1' c='3'/><bt id='12' v='1.2' c='0'/><bt id='13' v='3.3' c='3'/><bt id='14' v='3.3' c='3'/><bt id='15' v='3.3' c='3'/><bt id='16' v='3.3' c='3'/>");
 

BatteryCells[0].Voltage=3.34;
BatteryCells[1].Voltage=3.36;
BatteryCells[2].Voltage=3.38;
BatteryCells[3].Voltage=3.37;
BatteryCells[4].Voltage=3.35;
BatteryCells[5].Voltage=3.32;
BatteryCells[6].Voltage=3.32;
BatteryCells[7].Voltage=3.34;
...
//	sprintf(str, "'%.3f'",BatteryCells[i].Voltage);
//	putsUSART(str);
	sprintf(str, "%d'",3+i);
	putsUSART(str);
